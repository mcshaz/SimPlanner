...
export default angular
        .module('app')
        .controller(controllerId, courseParticipantCtrl).name;

    (courseParticipantCtrl as any).$inject = ['common', 'datacontext', 'breeze', '$scope', 'participantBase.abstract', 'selectOptionMaps'];
