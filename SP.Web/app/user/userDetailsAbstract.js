...
angular_1.default.module('app').factory(serviceId, ['common', 'datacontext', '$q', 'participantBase.abstract', 'tokenStorageService', '$routeParams', AbstractUserDetails]);
function AbstractUserDetails(common, datacontext, $q, abstractParticipantBase, tokenStorageService, $routeParams) {
    ...
    function Ctor(argObj) {
        ...
        vm.isNew = id === 'new';
        vm.emailChanged = vm.isNew ? emailChanged : angular_1.default.noop;
        function activate() {
            var alertMessage;
...
//# sourceMappingURL=userDetailsAbstract.js.map