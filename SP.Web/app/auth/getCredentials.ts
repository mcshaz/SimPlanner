...
export default angular.module('app')
            .controller(controllerId, ['$scope', 'loginFactory', 'common', 'ngAuthSettings', '$location', '$window', getCredentials]).name;
    ...
    function getCredentials($scope, loginFactory, common, ngAuthSettings, $location, $window) {
        ...
        vm.authExternalProvider = function (provider) {
            ...
            return $window.open(externalProviderUrl, "Authenticate Account", 'resizeable=1,status=0,' + windowSize($window,0.8,300)); //,width=600,height=750,location=0
        };
