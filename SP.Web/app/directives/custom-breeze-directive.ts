...
export default angular.module('breeze.directives', [])
    ...
    */
    function zValidate(config, validateInfo) {
        ...
        function link(scope, element, attrs) {
            ...
            function linkForInput() {
                ...
                var decorator:any = angular.element('<span class="z-decorator"></span>');
                if (attrs.zAppendTo) {
    ...
    function zValidateInfo() {
        ...
        function Info(scope, modelPath, validationPath) {
            ...
            this.isRequired = void 0; // don't know initially
        }
        ...
        function getIsRequired() {
            var info = this;
            if (info.isRequired !== void 0) { return info.isRequired; }
