...
export default angular.module('app').factory(serviceId, ['breeze', 'common', '$q', factory]);
...
function factory(breeze, common, $q) {
    var Repository = (function () {
        ...
        var repository = function (manager, entityTypeName, resourceName, fetchStrategy) {
            ...
            function executeQuery(query: any, force: boolean = false) {
                var fetch = force
                ...
                return manager
                    ...
                    .then(function (data) {
                        if (data.inlineCount !== void 0) { data.results.inlineCount = data.inlineCount; }
                        return data.results;
                    }, log.error );
            }
