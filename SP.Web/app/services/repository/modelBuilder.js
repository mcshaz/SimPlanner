...
var breezeValidators_1 = require("./../../breezeValidators");
...
function factory(breeze) {
    ...
    function extendCourse(metadataStore) {
        ...
        CourseCtor.prototype.addParticipant = function (participant) {
            if (!participant.entityAspect) {
                throw new TypeError("addParticipant requires a participant entity as an argument");
            }
            var keys = {
            ...
            if (arguments.length > 1) {
                angular_1.default.extend(keys, arguments[1]);
            }
        ...
        var courseInitializer = function () {
            ...
            Object.defineProperty(CourseCtor.prototype, 'day', {
                value: 1,
                writable: false,
                enumerable: true,
                configurable: true
    ...
    function extendValidators(metadataStore) {
        ...
        for (var typeName in breezeValidators_1.default) {
            if (breezeValidators_1.default.hasOwnProperty(typeName)) {
                var repo = metadataStore.getEntityType(typeName);
                breezeValidators_1.default[typeName].forEach(function (propName) {
