...
export default angular
    ...
    (courseTypesCtrl as any).$inject = ['common', 'datacontext', '$routeParams', 'controller.abstract', '$scope', '$http', 'tokenStorageService', '$location', 'USER_ROLES', 'selectOptionMaps', 'googleTools'];
