(function () {
    ...
    function datacontext($injector, $rootScope, common, config, emFactory, model, zStorage, zStorageWip) {
        ...
        var primePromise;
        var repoNames = ['aspNetUser', 'country', 'department', 'sessionRoleType', 'scenarioRoleType', 'hospital', 'instructorCourse', 'instructorCourseParticipant', 'manequin', 'professionalRole', 'scenario', 'scenarioResource', 'session', 'sessionParticipant', 'sessionResource', 'sessionType'];
        var $q = common.$q;
