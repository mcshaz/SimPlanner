...
namespace SM.MyIdentityProviders
{
    /*
    /// <summary>
    ...
    public class UserStore<TUser> :
        ...
        IUserStore<TUser> where TUser : IIdentityUser
    {
        /// <summary>
    ...
    */
    ...
    public class MyUserStore<TUser, TRole, TKey, TUserLogin, TUserRole, TUserClaim> :
        ...
        where TUser : class, IIdentityUser<TKey, TUserLogin, TUserRole, TUserClaim>
        ...
        where TUserClaim : IdentityUserClaim<TKey>, new()
    {
        ...
        public virtual async Task AddToRoleAsync(TUser user, string roleName)
        {
            ...
            {
                throw new ArgumentException(MyIdentityResources.ValueCannotBeNullOrEmpty, "roleName");
            }
            ...
            if (roleEntity == null)
            {
                throw new InvalidOperationException(String.Format(CultureInfo.CurrentCulture,
                    MyIdentityResources.RoleNotFound, roleName));
            }
