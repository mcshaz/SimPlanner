            ...
            _maps = new ReadOnlyDictionary<string, LambdaExpression>(
                CreateMapDictionary(
                    new[] {
                        ...
                        new DtoMap(typeof(CourseSlotManequin),  CourseSlotManequinMaps.mapFromRepo()),
                        ...
                        new DtoMap(typeof(CourseTypeScenarioRole),  CourseTypeScenarioRoleMaps.mapFromRepo()),
                        new DtoMap(typeof(Department),  DepartmentMaps.mapFromRepo(), true,"OutreachingDepartment"),
                        new DtoMap(typeof(FacultyScenarioRole),  FacultyScenarioRoleMaps.mapFromRepo()),
                        new DtoMap(typeof(Institution),  InstitutionMaps.mapFromRepo()),
                        new DtoMap(typeof(Manequin),  ManequinMaps.mapFromRepo()),
                        new DtoMap(typeof(ManequinModel),  ManequinModelMaps.mapFromRepo(),true,"Model", "Models"),
